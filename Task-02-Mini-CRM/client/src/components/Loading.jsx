...
const LoadingPage = ({ message = "Loading CRM Dashboard..." }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full bg-slate-50 relative overflow-hidden font-sans">
      ...
      <div className="flex flex-col items-center space-y-6 z-10">
        ...
        <div className="w-48 h-1.5 bg-slate-200 rounded-full overflow-hidden relative">
          <div className="absolute top-0 bottom-0 left-0 bg-gradient-to-r from-orange-500 to-rose-600 rounded-full animate-[loading_1.5s_infinite_ease-in-out]" />
        </div>
